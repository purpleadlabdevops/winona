<template>
  <section class="review">
    <div class="container">
      <div class="review__img"><img src="@/assets/review.png" alt=""></div>
      <div class="review__info">
        ...
        <div class="review__name">Lisa W., 58</div>
      </div>
    </div>
  </section>
</template>
...
.review{
  background: rgb(199 189 255 / 30%);
  padding-top: res(60, 120);
