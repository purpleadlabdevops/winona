          ...
          <carousel v-bind="slider.settings" :breakpoints="slider.breakpoints">
            <slide v-for="(item, index) in slider.items" :key="`slide_${index}`">
              <div class="patients__item">
                ...
                <div class="patients__title">{{ item.title }}</div>
                <div class="patients__text">{{ item.text }}</div>
                <div class="patients__foot">
                  <b>{{ item.name }},</b><span>&nbsp;{{ item.date }}</span>
                </div>
              </div>
            </slide>
            <template #addons>
